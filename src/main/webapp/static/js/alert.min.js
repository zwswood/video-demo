    ...
    var jqueryAlert = function (opts) {
        ...
        dialog.framework = function () {
            ...
            if (option.position == "fixed") {
                $container.css({"position": option.position, "left": "50%", "top": "50%", "z-index": zIndex,})
            }
            ...
            for (var key in option.buttons) {
                ...
                if (option.style == "wap") {
                    $button.css({"width": Math.floor(($container[0].clientWidth) / dialog.buttonsLength),})
                }
            ...
            if (option.style == "actionsheet") {
                ...
                $container.animate({"bottom": "0",}, dialog.time)
            }
        ...
        dialog.toggleAnimate = function () {
            if (option.style != "actionsheet") {
                ...
                return $container.animate({"bottom": "-100%",}, dialog.time)
            }
        };
        ...
        dialog.show = function () {
            ...
            if (option.style != "actionsheet") {
                ...
                if (option.position == "absolute") {
                    $container.css({"top": $(window).height() / 2 + $(window).scrollTop(),})
                }
            } else {
                $container.fadeIn(0).animate({"bottom": "0",}, dialog.time)
            }
            $modal.fadeIn(dialog.time);
